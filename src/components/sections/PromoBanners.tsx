  ...
  return (
    <div className="container section-gap">
      <div className="promo-grid">
        <a href="/new-arrivals" className="promo-card" style={{
        ...
        <a href="/product/kospet-tank-s2/" className="promo-card" style={{
          background: "linear-gradient(135deg, #b71c1c 0%, #e53935 100%)"
        }}>
          <div className="promo-text">
            <strong>New Arrival Product</strong>
            <span>Great deals on Smart Watch</span>
          </div>
          <span style={{ position: "absolute", right: "20px", fontSize: "48px" }}></span>
        </a>
      </div>
